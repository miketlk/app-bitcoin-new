...
static const asset_test_data_t asset_test_data[] = {
    ...
    // ciao.it reissuance token for TTT asset
    {
        .asset_tag = { // Tag of the reissuance token
            0xb0, 0x7a, 0xe0, 0x77, 0xd3, 0x9f, 0x71, 0x70,
            0x73, 0x2a, 0xe0, 0xd3, 0x5f, 0x62, 0x7f, 0xeb,
            0xf5, 0x0a, 0x0a, 0x66, 0x5e, 0x85, 0x6f, 0xb8,
            0x95, 0x93, 0x41, 0xd6, 0x66, 0x7e, 0xf8, 0xff
        },
        .contract_hash = {
        ...
        .prevout_txid = {
            0x2c, 0x0b, 0x75, 0xc9, 0xa0, 0x73, 0x4a, 0xaf,
            0x33, 0x1f, 0x9d, 0xdd, 0xbb, 0x14, 0xfc, 0x65,
            0xcc, 0x82, 0x8a, 0xcb, 0x33, 0x20, 0x5b, 0x16,
            0x9e, 0x2e, 0xdd, 0x59, 0xf7, 0x9f, 0xf9, 0xb2
        },
        .prevout_index = 1,
        .entropy = {
            0x7c, 0x1e, 0xd2, 0x3e, 0x22, 0xaf, 0x34, 0x4a,
            0x30, 0x89, 0xcf, 0x7c, 0xc7, 0x55, 0x97, 0xcd,
            0x99, 0x2d, 0xa8, 0x73, 0xd5, 0x9b, 0x26, 0x2e,
            0x83, 0xc9, 0xeb, 0x28, 0xa4, 0x4a, 0xce, 0xd7
        },
        .asset_class = ACLASS_REISSUANCE_TOKEN_NON_CONFIDENTIAL
    },
    // ELIP 100: example.com TEST (Testcoin)
    {
        ...
        .prevout_index = 1,
        .entropy = {
            0x24, 0x4c, 0x65, 0xb9, 0xae, 0x01, 0x97, 0x51,
            0x1a, 0x49, 0xd6, 0xb0, 0xdd, 0x04, 0x60, 0xe8,
            0xfc, 0x08, 0x26, 0xe5, 0x62, 0x6c, 0xba, 0x16,
            0xd5, 0xa7, 0xfa, 0x8f, 0x1b, 0xd0, 0xed, 0xb5
        },
        .asset_class = ACLASS_ASSET
    },
