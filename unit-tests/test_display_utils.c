...
static const struct {
    ...
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 0,
     .expected = "TICKR 18446744073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 1,
     .expected = "TICKR 1844674407370955161.5"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 2,
     .expected = "TICKR 184467440737095516.15"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 3,
     .expected = "TICKR 18446744073709551.615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 4,
     .expected = "TICKR 1844674407370955.1615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 5,
     .expected = "TICKR 184467440737095.51615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 6,
     .expected = "TICKR 18446744073709.551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 7,
     .expected = "TICKR 1844674407370.9551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 8,
     .expected = "TICKR 184467440737.09551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 9,
     .expected = "TICKR 18446744073.709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 10,
     .expected = "TICKR 1844674407.3709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 11,
     .expected = "TICKR 184467440.73709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 12,
     .expected = "TICKR 18446744.073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 13,
     .expected = "TICKR 1844674.4073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 14,
     .expected = "TICKR 184467.44073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 15,
     .expected = "TICKR 18446.744073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 16,
     .expected = "TICKR 1844.6744073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 17,
     .expected = "TICKR 184.46744073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 18,
     .expected = "TICKR 18.446744073709551615"},
    {.coin = "TICKR", .amount = 18446744073709551615LLU, .decimals = 19,
